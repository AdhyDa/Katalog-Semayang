...
@section('content')
    ...
    {{-- Container Form (Max Width agar rapi) --}}
    <div class="w-full max-w-2xl">
        {{-- Pastikan route action sesuai dengan route update password admin Anda --}}
            ...
            <div x-data="{ show: false }">
                ...
                <div class="relative">
                    <input :type="show ? 'text' : 'password'"
                            ...
                            class="w-full px-5 py-3 border-2 border-[#718355] rounded-xl outline-none focus:ring-4 focus:ring-[#718355]/20 transition text-gray-700 placeholder-gray-400 bg-white">
