...
class KatalogController extends Controller
{
    ...
    public function show($id)
    {
        ...
        $formattedProduct['package'] = is_array($product->included_items) ? implode(', ', $product->included_items) : ($product->included_items ?: 'Paket sudah termasuk: Topi bulu, rompi manik, dan rok rumbai.');
